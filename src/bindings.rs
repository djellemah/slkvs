    ...
    pub mod component {
      ...
      pub mod api {
        ...
        const _: () = {
          ...
          #[allow(non_snake_case)]
          unsafe extern "C" fn __export_addtree(arg0: i32,arg1: i32,arg2: i32,arg3: i32,) -> i32 {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
            ...
            let len1 = arg3 as usize;
            let bytes1 = Vec::from_raw_parts(arg2 as *mut _, len1, len1);
            let result2 = <_GuestImpl as Guest>::addtree(wit_bindgen::rt::string_lift(bytes0), wit_bindgen::rt::string_lift(bytes1));
          ...
          const _: () = {
            #[doc(hidden)]
            #[export_name = "cabi_post_golem:component/api#addtree"]
            #[allow(non_snake_case)]
            unsafe extern "C" fn __post_return_addtree(arg0: i32,) {
              let l0 = i32::from(*((arg0 + 0) as *const u8));
              match l0 {
                0 => (),
                _ => {
        ...
        const _: () = {
          ...
          #[doc(hidden)]
          #[export_name = "golem:component/api#drop"]
          #[allow(non_snake_case)]
          unsafe extern "C" fn __export_drop() {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 656] = [3, 0, 5, 115, 108, 107, 118, 115, 0, 97, 115, 109, 13, 0, 1, 0, 7, 170, 1, 1, 65, 2, 1, 66, 15, 1, 64, 2, 4, 112, 97, 116, 104, 115, 5, 118, 97, 108, 117, 101, 115, 1, 0, 4, 0, 3, 97, 100, 100, 1, 0, 1, 107, 115, 1, 64, 1, 4, 112, 97, 116, 104, 115, 0, 1, 4, 0, 3, 103, 101, 116, 1, 2, 1, 112, 115, 1, 64, 0, 0, 3, 4, 0, 9, 108, 105, 115, 116, 112, 97, 116, 104, 115, 1, 4, 1, 106, 0, 1, 115, 1, 64, 2, 4, 112, 97, 116, 104, 115, 4, 106, 115, 111, 110, 115, 0, 5, 4, 0, 7, 97, 100, 100, 116, 114, 101, 101, 1, 6, 1, 64, 1, 4, 112, 97, 116, 104, 115, 1, 0, 4, 0, 6, 100, 101, 108, 101, 116, 101, 1, 7, 1, 64, 0, 1, 0, 4, 0, 4, 100, 114, 111, 112, 1, 8, 4, 1, 19, 103, 111, 108, 101, 109, 58, 99, 111, 109, 112, 111, 110, 101, 110, 116, 47, 97, 112, 105, 5, 0, 11, 9, 1, 0, 3, 97, 112, 105, 3, 0, 0, 7, 199, 1, 1, 65, 2, 1, 65, 2, 1, 66, 15, 